...
const HIVE_I18N = {
    zh: {
        ...
        settings: {
            ...
            pleaseConfigureLLM: '请先在设置界面配置大语言模型API',
            pleaseConfigureVision: '请先在设置界面配置视觉模型API',
            apiUrl: 'API地址',
    ...
    en: {
        ...
        settings: {
            ...
            configureLLMAPI: 'Configure LLM API',
            llmAPIConfig: 'Large Language Model API Configuration',
            ...
            pleaseConfigureLLM: 'Please configure Large Language Model API in settings first',
            pleaseConfigureVision: 'Please configure Vision Model API in settings first',
            apiUrl: 'API URL',
