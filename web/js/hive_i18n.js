...
const HIVE_I18N = {
    zh: {
        ...
        photoPrompt: {
            copyPrompt: '复制提示词',
            promptCopied: '提示词已复制到剪贴板',
            photoPromptGenerator: 'Hive 摄影提示词生成器',
            photoPromptGenerating: '正在生成摄影提示词...',
            photoPromptGenerated: '摄影提示词已生成',
            photoPromptFailed: '生成摄影提示词失败：',
            location: '地点',
            selectLocation: '选择地点',
            person: '人物',
            selectPerson: '选择人物',
            ...
            randomSettings: '随机设定',
            deletePreset: '删除预设',
            confirmDeletePreset: '确定要删除预设"{name}"吗？',
            noPresets: '暂无预设',
            presetSaved: '预设已保存',
            presetLoaded: '预设已加载',
            presetDeleted: '预设已删除',
            leastOneParameter: '请至少选择一个参数',
            male: '男性',
            female: '女性',
            neutral: '中性',
            portrait: '肖像',
            ...
            selectIso: '选择ISO',
            colorTemperature: '色温',
            selectColorTemperature: '选择色温',
            whiteBalance: '白平衡',
            selectWhiteBalance: '选择白平衡',
            shutterSpeed: '快门',
            selectShutterSpeed: '选择快门',
            shallow: '浅景深',
            deep: '深景深',
            bokeh: '背景虚化',
            wide: '广',
        ...
        // 提示词收藏功能相关
        promptFavorite: {
            promptFavorite: 'Hive 提示词收藏',
            title: '提示词收藏',
            addFavorite: '新增收藏',
            editFavorite: '编辑收藏',
            deleteFavorite: '删除收藏',
            confirmDeleteFavorite: '确定要删除这条收藏吗？',
            ...
            editCategory: '编辑分类',
            deleteCategory: '删除分类',
            confirmDeleteCategory: '确定要删除分类"{name}"吗？删除后该分类下的所有收藏将移至"无分类"。',
            ...
            promptContentRequired: '请输入提示词内容',
            cancel: '取消',
            save: '保存',
            edit: '编辑',
            delete: '删除',
            ...
            importSuccess: '导入成功',
            importFailed: '导入失败',
            invalidImportData: '导入数据格式无效',
            addTime: '添加时间',
            previousPage: '上一页',
            nextPage: '下一页',
            pageInfo: '第 {page} / {totalPages} 页，共 {total} 条',
            importConfirmWithDuplicates: '导入数据包含：\n- {newFavorites}条新收藏（{duplicateFavorites}条重复，将跳过）\n- {newCategories}个新分类（{duplicateCategories}个重复，将跳过）\n\n确定要导入吗？',
            importConfirm: '确定要导入数据吗？这将{newFavorites}条收藏和{newCategories}个分类添加到现有数据中。',
    ...
    en: {
        ...
        photoPrompt: {
            copyPrompt: 'Copy Prompt',
            promptCopied: 'Prompt copied to clipboard',
            photoPromptGenerator: 'Hive Photo Prompt Generator',
            photoPromptGenerating: 'Generating photo prompt...',
            photoPromptGenerated: 'Photo prompt generated',
            photoPromptFailed: 'Failed to generate photo prompt: ',
            location: 'Location',
            ...
            leastOneParameter: 'Please select at least one parameter',
            male: 'Male',
            female: 'Female',
            neutral: 'Neutral',
            portrait: 'Portrait',
            ...
            aperture: 'Aperture',
            selectAperture: 'Select Aperture',
            iso: 'ISO',
            selectIso: 'Select ISO',
            colorTemperature: 'Color Temperature',
            selectColorTemperature: 'Select Color Temperature',
            whiteBalance: 'White Balance',
            selectWhiteBalance: 'Select White Balance',
            shutterSpeed: 'Shutter Speed',
            selectShutterSpeed: 'Select Shutter Speed',
            shallow: 'Shallow',
            deep: 'Deep',
            bokeh: 'Bokeh',
            wide: 'Wide',
            ...
            artistic: 'Artistic',
            ethnicity: 'Ethnicity/Region',
            selectEthnicity: 'Select Ethnicity/Region',
            asia: 'Asia',
            europe: 'Europe',
        ...
        promptFavorite: {
            promptFavorite: 'Hive Prompt Favorite',
            ...
            confirmDeleteCategory: 'Are you sure you want to delete category "{name}"? All favorites in this category will be moved to "No Category".',
            ...
            promptContentRequired: 'Please enter prompt content',
            cancel: 'Cancel',
            save: 'Save',
            edit: 'Edit',
            delete: 'Delete',
            ...
            invalidImportData: 'Invalid import data format',
            addTime: 'Added Time',
